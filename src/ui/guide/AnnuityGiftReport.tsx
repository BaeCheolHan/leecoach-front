      ...
      <article>
        ...
        <section className="card tldr">
          ...
          <ol>
            ...
            <li>
              필요한 서류는 총 3가지 — 이 중 <b>계약서·평가명세서 2장</b>은 이 사이트에서 무료로 만듭니다.
            </li>
          </ol>
        </section>
        ...
        <section className="card guide-section">
          <h2>3. 필요한 서류는 총 3가지</h2>
          <ul className="doc-list">
            <li>
              <b>가족관계증명서</b>
              <span>아이(수증자) 기준 '상세'로 발급. 정부24나 주민센터에서 준비.</span>
            </li>
            <li>
              <b>유기정기금 평가명세서</b>
          ...
          <p>
            이 중 <b>평가명세서와 증여계약서 2장은 자동으로 생성됩니다</b> — 이름·금액·기간만 입력하면 PDF로
            완성돼요. 정보는 서버로 전송되지 않아요.
          </p>
          <p>
            매달 얼마를 보내면 아이가 성인이 될 때 얼마가 되는지는{' '}
            <a href="/simulator">증여자산 시뮬레이터</a>에서 계산해 볼 수 있습니다.
          </p>
          <ToolCta />
        </section>
