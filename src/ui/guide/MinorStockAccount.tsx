...
const FAQ: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: '신고된 원금의 운용 수익은 추가 증여가 아닙니다. 잦은 매매로 부모가 적극 운용한 경우는 예외가 될 수 있습니다.',
  },
  {
    q: '해외 주식도 살 수 있나요?',
    ...
    <GuideLayout>
      <article>
        ...
        <section className="card guide-section">
          ...
          <p>신고된 원금으로 산 주식의 가격 상승과 배당은 추가 증여가 아닙니다. 자녀 자산의 운용 수익입니다.</p>
          <p className="guide-note">
            단, 부모가 자녀 계좌에서 잦은 매매로 적극 운용해 얻은 이익은 증여로 보는 과세 사례가 있으므로 장기
            보유 위주가 안전합니다.
          </p>
          <p>이래서 “일찍, 한도만큼, 신고하고, 오래 보유”가 정석 전략입니다.</p>
        </section>
