...
describe('presetEndDate', () => {
  it('시작일 + N년 - 1일을 계산한다', () => {
    expect(presetEndDate('2026-08-01', 10)).toBe('2036-07-31');
    expect(presetEndDate('2026-01-01', 5)).toBe('2030-12-31');
  });
  it('윤년 경계를 처리한다', () => {
    expect(presetEndDate('2024-02-29', 1)).toBe('2025-02-28');
  });
});
